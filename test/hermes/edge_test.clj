...
(deftest test-edges
  ...
  (testing "Refresh"
    (let [v1 (g/transact! (v/create! {:name "v1"}))
      ...
      (is (g/transact! (= (e/to-map (e/refresh edge)) (e/to-map (e/refresh fresh-edge)))))))
  ...
  (testing "Edges between"
    (let [v1 (g/transact! (v/create! {:name "v1"}))
      ...
      (is edge)
      (is (g/transact! (= (e/to-map (e/refresh edge))
                          (e/to-map (e/refresh (first found-edges))))))))
